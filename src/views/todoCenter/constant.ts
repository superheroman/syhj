const urlMap = {
  ...
  StructBomAudit: "/bomView/struc", //结构bom审核界面
  StructBomImport: "/structuralMaterialImport/index", //结构bom导入界面
  ...
  NreInputEmc: "/nre/nrePilotprojects", //NRE核价电子-EMC实验费录入界面"
  NreInputMould: "/nre/nreResourcesDepartment", //NRE模具清单录入界面
  NreInputTest: "/nre/nreExperimentItems", //NRE实验费用录入界面
  ...
  PriceCheckDownload: "/quoteAnalysis/index", //"版本的核价表查看&下载界面（产品+NRE）"
